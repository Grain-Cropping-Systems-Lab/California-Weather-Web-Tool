...
#' @param current_start_date user defined start date
#' @param end_date seasonal end date given the region and the user defined end_date
#' 
...
#'
#' @examples
#' prism_historical_season_all(con = con, lat = 38.533867, long = -121.771598, current_start_date = "2019-10-01", end_date = "2020-06-30")
